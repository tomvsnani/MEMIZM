...
class TextFontFamilyAdapter(var param: (position: Int) -> Unit) :
    ListAdapter<String, TextFontFamilyAdapter.MainContentViewHolder>(object :
    ...
    override fun onBindViewHolder(holder: MainContentViewHolder, position: Int) {
        ...
        holder.binding.textcolorChnageButton.text = model
