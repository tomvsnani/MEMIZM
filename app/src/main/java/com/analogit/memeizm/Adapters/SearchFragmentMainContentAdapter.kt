...
class SearchFragmentMainContentAdapter(var activity: Activity?) :
    ListAdapter<MainContentModel, SearchFragmentMainContentAdapter.MainContentViewHolder>(
        MainContentModel.diff
    ) {
