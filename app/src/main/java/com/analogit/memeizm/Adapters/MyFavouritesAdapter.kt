...
class MyFavouritesAdapter(var activity: Activity?) :
    ListAdapter<MainContentModel, MyFavouritesAdapter.MainContentViewHolder>(MainContentModel.diff) {
    inner class MainContentViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            binding.apply {
                ...
                saveImageView.setImageResource(R.drawable.ic_baseline_delete_outline_24)
