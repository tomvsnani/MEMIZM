...
class SearchFragmentCategoryAdapter :
    ListAdapter<MainCategoryModelClass, SearchFragmentCategoryAdapter.MainCategoryViewHolder>(MainCategoryModelClass.diffUtil) {
